...
DB_URI = os.environ.get("DB_URI", "mongodb-srv://mihaja5084: yeIh95RrMkRNZ31t@cluster0 .6voc3fm.mongodb.net/?retrywrites=true&w= majority") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
